...
import ExampleDrifeExampleDrifeDrife from './example/drife/example.drife.drife'
...
export default { 
  ...
  ExampleDrifeExampleDrifeDrife: load(ExampleDrifeExampleDrifeDrife, 'example.drife.drife'),
